...
urlpatterns = [
    ...
    path('rooms/<int:room_id>/workspaces/', RoomWorkspaceSnapshotListView.as_view(), name='room-workspaces'),
    ...
    path('rooms/<int:room_id>/questions/<int:question_id>/snapshot/', StudentWorkspaceSnapshotView.as_view(), name='student-workspace-snapshot'),
